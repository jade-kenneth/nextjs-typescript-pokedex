...
import { PokemonListProps } from "pages/ssr/pokemon";
import { PokemonDataProps } from "pages/ssr/pokemon/[pokemonId]";
...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  const paths = data.results.map((pokemon: any, idx: number) => {
    return {
